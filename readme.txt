...
Using this widget you can easily place the Kindle DX 3 Graphite containing an image of the cover of the book you are reading in the sidebar. You can also specify a URL to link to when clicking on the book cover image. Supports multiple instances, so you can use it multiple times in multiple sidebars. (adapted from the Simple Image Widget)
...
1. Copy/upload the `Kindle-DX-3-Graphite-Widget` folder to your `/wp-content/plugins/` directory
...
`.kindledxthreegraphite { text-align: center; }
.kindledxthreegraphite { margin:0 auto; }
.kindledxthreegraphite { margin:0 auto; text-align: center; }
.kindledxthreegraphite { margin:0 auto; text-align: left; }
.kindledxthreegraphite { margin-top:0px; margin-right:0px; margin-bottom:0px; margin-left:0px; }`
